            ...
            <div class="col-sm-2">
                ...
                <div class="card">
                    ...
                    <div class=" card-container">
                        <h4 style="font-family: 'Poppins', sans-serif;"><b><?= \app\models\User::findOne(['id' => Yii::$app->user->getId()])->username;?></b></h4>
                        <p style="font-family: 'Poppins', sans-serif;"><?= \app\models\User::findOne(['id' => Yii::$app->user->getId()])->username;?></p>
                        <p class="this_p" style="overflow-x: auto; font-family: 'Poppins', sans-serif;"><?= \app\models\User::findOne(['id' => Yii::$app->user->getId()])->email;?></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-10">
                ...
                <div class="col-sm-3">
                    <div class="col-sm-12">
                        <h5 style="font-weight: bold; font-family: 'Poppins', sans-serif; font-size: 1.8rem; " class="text-left">Приложения  <span> &#35; 123 </span></h5>
                            ...
                            <input class="beauty_input" name='date' type="text" disabled value="05.03.2019 12:54pm">
                    </div>
                </div>
                <div class="row-no-gutters col-sm-12" style="height: auto; padding: 30px 20px;">
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <?= $form->field($model, 'rank')->textInput(['style' => 'width:90%;'])->label('Департамент. ' ,['class' => 'label-class-left'] )?>
                        </div>
...
<!--                    </div>-->
                ...
                <div class="col-sm-12 ">
                    <?= $form->field($model, 'application_edition')->textInput(['rows' => 2])
